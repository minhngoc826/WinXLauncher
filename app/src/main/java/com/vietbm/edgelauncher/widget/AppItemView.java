...
import com.vietbm.edgelauncher.viewutil.GroupIconDrawable;
...
public class AppItemView extends View implements Drawable.Callback {
    ...
    public AppItemView(Context context, AttributeSet attrs) {
        ...
        _textPaint.setTextSize(Tool.sp2px(10));
        _textPaint.setColor(Color.WHITE);
        _textPaint.setTypeface(createFromAsset);
    }
    ...
    public static class Builder {
        ...
        public Builder setShortcutItem(final Item item) {
            _view.setLabel(item.getLabel());
            _view.setIcon(item.getIcon());
            _view.setOnClickListener(v -> Tool.createScaleInScaleOutAnim(_view, () -> _view.getContext().startActivity(item.getIntent())));
            return this;
        }

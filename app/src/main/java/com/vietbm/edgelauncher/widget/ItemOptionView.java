...
import com.vietbm.edgelauncher.activity.homeparts.HpAppEditApplier;
import com.vietbm.edgelauncher.interfaces.DropTargetListener;
...
import com.vietbm.edgelauncher.viewutil.PopupIconLabelItem;
...
public final class ItemOptionView extends FrameLayout {
    ...
    private final FadeInAnimator _slideInLeftAnimator;
    ...
    public ItemOptionView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        _slideInLeftAnimator = new FadeInAnimator(new AccelerateDecelerateInterpolator());

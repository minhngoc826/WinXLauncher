...
import com.vietbm.edgelauncher.util.Definitions.ItemState;
...
import com.vietbm.edgelauncher.widget.CellContainer.DragState;
...
import static com.vietbm.edgelauncher.util.Definitions.WallpaperScroll.Inverse;
import static com.vietbm.edgelauncher.util.Definitions.WallpaperScroll.Normal;
import static com.vietbm.edgelauncher.util.Definitions.WallpaperScroll.Off;
            ...
            if (dropItem != null) {
                ...
                if (type != null) {
                    switch (type) {
                        ...
                        case GROUP:
                            if ((Type.APP.equals(dropItem._type) || Type.SHORTCUT.equals(dropItem._type)) && item.getGroupItems().size() < GroupPopupView.GroupDef._maxItem) {
                                parent.removeView(itemView);
    ...
    public final void updateIconProjection(int x, int y) {
        ...
        switch (state) {
            ...
            case CurrentOccupied:
                Type type = dragNDropView.getDragItem()._type;
